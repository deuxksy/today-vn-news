...
- [x] **안전 및 기상 관제 (Priority 0)**: 호치민 날씨, AQI(미세먼지) 수집 및 마스크 권고 로직 구현
- [ ] **수집 대상 확대**: 7대 주요 일간지(VnExpress, Tuổi Trẻ, Thanh Niên 등) 전체로 수집 범위 확장
- [ ] **긴급 특보 엔진**: 재난 상황(태풍, 지진 등) 발생 시 최상단 `🚨 [긴급 특보]` 자동 삽입 로직
...
- [ ] **통합 로그 시스템**: `YYMMDD_control.log`를 통한 전체 파이프라인 상태 관제

---
*마지막 갱신: 2026-01-06 (ContextFile v1.1 기준)*