...
- **출력 품질 고도화**: 리포트 내 AI의 내부 진행 과정 및 인삿말 등 메타 정보 출력을 원천 차단.
- **마크다운 규격 준수**: 매체명(`##`), 기사제목(`###`) 계층 구조를 명확히 정의하여 TTS 및 가독성 개선.
- **수집 순서 고정**: `ContextFile.md` 명세(7.1~7.8) 순서대로 수집하도록 로직 동기화.

## [0.3.2] - 2026-01-06 [Internal]
