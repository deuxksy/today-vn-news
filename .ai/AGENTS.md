...
- **프로젝트명**: today-vn-news
- **핵심 가치**: 베트남 뉴스 제작 자동화 및 개인화된 정보(건강/IT) 큐레이션.
...
- **권한 요청**:
  - `CONTEXT.md`,`AGENTS.md`, `ROADMAP.md`는 절대 삭제 불가능.
  - `CONTEXT.md`,`AGENTS.md`, `ROADMAP.md`는 수정 할때만 사용자의 명시적 승인을 요청한다.
  - `CONTEXT.md`,`AGENTS.md`, `ROADMAP.md`를 제외한 모든 파일 및 작업(삭제, 수정 등)은 사용자의 별도 승인 없이 자율적으로 수행한다.
